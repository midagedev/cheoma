...
//   · 원리 ④ 실루엣에 무게가 몰리고 내부에 적다 → 캐노피 전체를 감싸는 구의 노멀을 전사한다
//     (bakeSphericalNormals). 노멀이 연속해지면 캐노피 안쪽 폴리곤 패싯이 셰이더 수정 없이
//     사라진다(docs/tree-look.md §3.3).
//
...
//   정점에 굽는다. 개별 덩이가 하나의 둥근 매스처럼 셰이딩되고, 노멀 불연속이 사라져
//   내부 폴리곤 패싯이 소멸한다. 런타임 비용 0.

...
[`SANSA-HANDOFF.md`](../SANSA-HANDOFF.md)의 #5 사찰 터 재배치는 구현·에이전트 시각 검토·사람 승인을 마쳤다. 산사를 강제하지 않고 평지·완경사·계류변·도성 안을 허용하며, 산과 숲의 위요감은 보너스일 뿐 필수가 아니다. temple ON plan과 scene 골든만 의도적으로 바뀌고 temple OFF 골든은 그대로 유지하는 것이 승인된 계약이다.

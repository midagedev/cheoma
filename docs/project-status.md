...
- 일반 필지 근경은 남측 일조축 안의 정확한 22° 카메라 고도와 1.65–2.5m 문 높이 조준을 유지한다. 10° 제품 프레임에서 마당과 생활 소품을 더 보여 달라는 연속 사용자 검수에 따라 12°·14°·16°·18°·20°를 거쳐 22°로 올렸으며, 별도 수직 composition은 0으로 두어 집과 전경 마당을 화면 밖으로 밀지 않는다.
...
공유한다. 최초 등장은 70° 안의 완만한 establishing 호와 넓은 화각에서 출발해 정확한 22°·문 높이 망원

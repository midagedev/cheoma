...
- 마을 부감은 공간을 읽는 46° 광각, 일반 필지·hero·궁·사찰 근경은 형태와 배경 압축을 살리는 10°/7°/24°/26° 망원을 사용한다. 24mm 세로 센서 환산으로 일반 필지는 약 137mm, hero는 약 196mm라 200mm급 망원 인상을 낸다. 23°/21° reference FOV에서 보상 dolly해 피사체 크기를 유지하고, 디테일 LOD·입자 휴면은 화면 등가 거리로 계산한다. 강수·꽃잎·낙엽·mote·한지 실용광은 실제 월드 크기를 가지며 authored camera projection으로만 화면 크기가 변한다.

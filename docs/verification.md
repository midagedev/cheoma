...
- `p31`의 기존 10° 시선은 렌더 지형을 두 번 통과했다. 안전 프레임은 정확한 terrain-grid 삼각형을 따라 첫 연결 구간만 쓰고, 전체 시선 1m·카메라 1.2m 여유, 24° 고도, 고정 reference FOV, 30° 이하의 건축 화각을 함께 단언한다. 다른 급경사 예외가 30°를 넘더라도 산속 구도로 돌아가지는 않는다.

...
조사일: 2026-07-16. 각 항목의 "검증" 표기는 조사 시점에 WebFetch로 실제 접속을 확인했는지 여부.
...
- URL: https://www.hanokdb.kr/theology/sub_04 (시공), sub_01(가치), sub_02(종류)
- 내용: 공포(주심포/다포/익공), 지붕(추녀·서까래·기와잇기), 칸, 창호, 천장 등 목조 구조 요소를 이미지 도해와 함께 해설. 부재 명칭·결구 체계 파악에 유용.
- 포맷: 웹(HTML) + 도해
- 라이선스·접근: 무료, 로그인 불필요
- 검증: 접속 확인

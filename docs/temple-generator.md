...
| 주불전 / 최고 부속 높이 (extended) | 1.33배 | 1.89배 | > 1.6배 |
...
사료 사진의 금강산 장안사 대웅보전은 **중층**이라 가람의 정점이 확실하다. 종전 주불전은 단층이라 부속과의 높이차가 1.33배(12.59 vs 9.46m)뿐이었고, 이제 **17.85m = 1.89배**다.
...
- 상층 층고는 하층의 0.70배, 기단은 없다(하층 구조 위에 앉으므로).

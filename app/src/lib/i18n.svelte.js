...
const DICT = {
  ko: {
    ...
    guide_desktop_house: '집을 눌러 가까이 보기',
    guide_desktop_exit: 'Esc 또는 둘러보기로 돌아가기',
    guide_touch_orbit: '한 손가락으로 드래그해 둘러보기',
    ...
    act_postcard: '사진 찍기', act_postcard_tip: '낙관을 더한 PNG 사진으로 저장',
    act_share: '공유', act_share_tip: '현재 장면 링크 공유',
    share_title: '처마 — 내가 지은 풍경', share_text: '처마에서 만든 한국의 집과 마을을 둘러보세요.',
    share_shared: '장면 링크를 공유했습니다',
    ...
    s_char01: '기와 비율', s_diversityK: '다양성', s_mjaHouse: 'ㅁ자 뜰집',
    vil_citywall_hint: '초락부터', vil_sijeon_hint: '도성부터', vil_river_hint: '도성부터',
    vil_mja_house_hint: '초락·마을에서만', vil_char_auto: '규모 자동',
    vil_reroll: '마을 다시 짓기', vil_reroll_tip: '마을을 통째로 다시 짓기 (해체→재생성→조립)',
    vil_reroll_house: '고쳐짓기', vil_reroll_house_tip: '이 집의 파라미터를 실시간으로 바꿔 고쳐 짓습니다',
    crumb_hanok: '종가', crumb_palace: '관아', crumb_palace_compound: '궁궐', crumb_temple: '사찰',
    nav_building: '건물 선택', nav_view: '보기', nav_move: '이동', nav_current: '현재',
    nav_moving: '이동 중…', nav_current_status: '현재 보고 있는 건물',
    nav_explore_status: '둘러보기에서 선택할 수 있습니다', nav_empty_status: '선택할 건물이 없습니다',
    nav_count_suffix: '채',
    vil_houses: '호',
  ...
  en: {
    ...
    guide_desktop_house: 'Select a house to move closer',
    guide_desktop_exit: 'Press Esc or Explore to return',
    guide_touch_orbit: 'Drag with one finger to orbit',
    ...
    act_postcard: 'Take photo', act_postcard_tip: 'Save a sealed PNG image',
    act_share: 'Share', act_share_tip: 'Share a link to this scene',
    share_title: 'cheoma — a scene I made', share_text: 'Explore this Korean house and village in cheoma.',
    share_shared: 'Scene link shared',
    ...
    cine_walk_hint: 'WASD / arrows to move · drag to look · Shift to hurry · Space to jump · Esc to exit',
    ...
    vil_reroll_house: 'Renovate', vil_reroll_house_tip: 'Live-morph this house’s parameters into a renovation',
    ...
    nav_moving: 'Moving…', nav_current_status: 'Current building',
    nav_explore_status: 'available from Explore', nav_empty_status: 'No buildings available',
    nav_count_suffix: ' buildings',

...
const DICT = {
  ko: {
    ...
    // glb 내보내기(#112)
    act_glb: 'GLB', glb_house_tip: '이 건물을 3D 모델로 내보내기 (.glb)',
    ...
    vil_temple_compound_note: '사찰 — 남향 예불축과 비움을 지키며 전각·마당·석조물 구성을 손봅니다.',
    ...
    s_undAmpK: '기복', s_ridgeHK: '능선 높이', s_streamMeanderK: '개울 사행', s_stream: '개울',
    s_paddyDensityK: '논 비율', s_treeDensityK: '나무 밀도', s_cityWall: '성곽', s_sijeon: '시전',
    s_char01: '기와 비율', s_diversityK: '다양성',
    vil_citywall_hint: '초락부터', vil_sijeon_hint: '도성부터', vil_char_auto: '규모 자동',
  ...
  en: {
    ...
    // glTF export (#112)
    act_glb: 'GLB', glb_house_tip: 'Export this building as a 3D model (.glb)',
    ...
    vil_temple_compound_note: 'Temple — tune halls, courts and stone monuments while preserving the south-facing worship axis and breathing room.',
    ...
    s_undAmpK: 'Undulation', s_ridgeHK: 'Ridge height', s_streamMeanderK: 'Stream meander', s_stream: 'Stream',
    ...
    vil_citywall_hint: 'hamlet+', vil_sijeon_hint: 'capital+', vil_char_auto: 'auto by scale',
